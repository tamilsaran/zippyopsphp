...
<div class="bg-top navbar-light">
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image:url(images//ban.jpg);" data-stellar-background-ratio="0.5">
    			...
    			<div class="col-md-4">
    				<div class="request-quote">
                      ...
                      <select name="opt" id="" class="form-control">
                        ...
                        <option value="Clasd Room Training">Class Room Training</option>
                        <option value="Consulting">Consulting</option>
	    					...
	    					<div class="form-group">
		              <textarea name="" id="" cols="30" rows="2" class="form-control" name="msg" placeholder="Message"></textarea>
		            </div>
		            <div class="form-group">
		              <input type="submit" value="Appointment" class="btn btn-primary py-3 px-4" name="submit">
		            </div>
		    			</form>
...
?>
	          ...
	          <div class="heading-section mb-5">
	            <h2 class="mb-4">We Are Highly Recommended Cloud & DevOps</h2>
	          </div>
	          <div class="">
							<p class="mb-5">A high-level introduction to what DevOps is.Communication, collaboration and integration are the three main principles of the ever-growing, modern approach to software delivery known as "DevOps". Coined in 2009 by Patrick Debois, the term (development and operations) is an extension of agile development environments that aims to enhance the process of software delivery as a whole.</p>
    ...
    <section class="ftco-services ftco-no-pt">
          ...
          <div class="col-md-8 text-center heading-section ftco-animate">
            ...
            <p>Corporate Training, Resourcing, Class Room Training, Consulting</p>
          </div>
        </div>
		...
		<div class="row">
          <div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
            ...
            <img src="images/s1.png" height="120" width="120"></img>
              </div>
              <div class="media-body p-2 mt-3">
                <h3 class="heading">Corporate Training</h3>
                <p>Organizations today suffer from a skills gap. And many companies say that it takes 3-5 years to take a seasoned professional and make them productive.</p>
				<p><a href="about.html" class="btn btn-secondary px-5 py-3">Read More</a></p>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center">
              <div class="justify-content-center align-items-center">
            		<img src="images/s2.png" height="120" width="120"></img>
              </div>
              <div class="media-body p-2 mt-3">
                <h3 class="heading">Class Room Training</h3>
                <p>Classroom training is considered the most effective form of learning. Attending a class requires an investment of time and effort, but the rewards are significant.</p>
				<p><a href="about.html" class="btn btn-secondary px-5 py-3">Read More</a></p>
              </div>
            </div>    
          </div>
          <div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center">
              <div class="justify-content-center align-items-center">
            			<img src="images/s3.png" height="120" width="120"></img>
              </div>
              <div class="media-body p-2 mt-3">
                <h3 class="heading">Consulting</h3>
                <p>We appoint the resource by on-demand and consulting service in DevOPS.</p><br />
<br />
<br />
          ...
          <div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center">
              <div class="justify-content-center align-items-center">
            		<img src="images/s4.png" height="120" width="120"></img>

              </div>
              <div class="media-body p-2 mt-3">
                <h3 class="heading">Resourcing</h3>
...
<br />
          ...
          <div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center">
              <div class=" justify-content-center align-items-center">
            <img src="images/i1.png" height="120" width="120"></img>
              </div>
              <div class="media-body p-2 mt-3">
                <h3 class="heading">Infrastructure</h3>
                <p>Amazon Web services, MSAzure, Google Cloud Platform, OpenStack, Vmware.</p>
				<p><a href="blog.html" class="btn btn-secondary px-5 py-3">Read More</a></p>
              </div>
            </div>      
          </div>
          ...
          <div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center" align="center">
              <div class="justify-content-center align-items-center">
            		<img src="images/i2.png" height="120" width="120"></img>
              </div>
              <div class="media-body p-2 mt-3">
                <h3 class="heading">Micro services</h3>
                <p>Docker, Kubernetes, Openshift, Istio, Rancher.</p>
<br />
          ...
          <div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center">
              <div class="justify-content-center align-items-center">
            			<img src="images/i3.png" height="120" width="120"></img>
              </div>
              <div class="media-body p-2 mt-3">
                <h3 class="heading">DevOPS</h3>
                <p>Git, Jenkins, Chef, Puppet, Ansible.</p>
<br />
          ...
          <div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center">
              <div class="justify-content-center align-items-center">
            		<img src="images/i4.png" height="120" width="120"></img>

              </div>
              <div class="media-body p-2 mt-3">
                <h3 class="heading">Security & Maintanance</h3>
                <p>Zabbix, ELK, Compliance Reporting, Prometheus, New Relic.</p>
				<p><a href="blog.html" class="btn btn-secondary px-5 py-3">Read More</a></p>
              </div>
            </div>      
          </div>
			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-md-9 text-center">
						...
						<p>“Showing a strong success and visible benefits is key to getting others to agree to try your way of doing things.” 
</p>
...
<br>
		<section class="ftco-section ftco-no-pt ftco-no-pb">
          ...
          <div class="col-md-6 text-center heading-section ftco-animate">
            ...
            <p>Here This is our sample projects.</p>
          </div>
        </div>
    		<div class="row no-gutters">
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
	    				...
	    				<div class="text">
	    					<span>Jenkins</span>
	    					<h3><a href="project.html">Jenkins for continous deployment</a></h3>
	    				</div>
